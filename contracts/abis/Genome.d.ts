...
/**
 * @description Represents the result of the injectRewards function call.
 */
export type InjectRewards = CallResult<
    {
        amount: bigint;
    },
    OPNetEvent<never>[]
...
// IGenome
// ------------------------------------------------------------------
export interface IGenome extends IOP_NETContract {
    wrap(): Promise<Wrap>;
    ...
    injectRewards(): Promise<InjectRewards>;
}
