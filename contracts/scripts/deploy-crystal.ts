...
console.log('=== CrystalToken Deployment ===');
console.log('Deployer p2tr   :', opnetP2TR);

const __dirname = dirname(fileURLToPath(import.meta.url));
const bytecode  = new Uint8Array(readFileSync(join(__dirname, '..', 'build', 'CrystalToken.wasm')));
...
console.log('\n=== Done ===');
console.log('CrystalToken address:', result.contractAddress);
console.log('CrystalToken pubkey :', result.contractPubKey);
