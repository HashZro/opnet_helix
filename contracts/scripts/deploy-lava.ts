...
console.log('=== LavaToken Deployment ===');
console.log('Deployer p2tr   :', opnetP2TR);

const __dirname = dirname(fileURLToPath(import.meta.url));
const bytecode  = new Uint8Array(readFileSync(join(__dirname, '..', 'build', 'LavaToken.wasm')));
...
console.log('\n=== Done ===');
console.log('LavaToken address:', result.contractAddress);
console.log('LavaToken pubkey :', result.contractPubKey);
