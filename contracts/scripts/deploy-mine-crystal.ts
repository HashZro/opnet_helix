...
const UNDERLYING_ADDRESS = process.env.CRYSTAL_UNDERLYING ?? '';
if (!UNDERLYING_ADDRESS) throw new Error('CRYSTAL_UNDERLYING not set in .env');

const MINE_DECIMALS = 18;
const MINE_NAME     = 'xCrystal';
const MINE_SYMBOL   = 'xCRYS';
...
console.log('=== xCrystal Mine Deployment ===');
...
console.log('\n=== Done ===');
console.log('xCrystal Mine address:', result.contractAddress);
console.log('xCrystal Mine pubkey :', result.contractPubKey);
