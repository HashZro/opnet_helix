...
if (!UNDERLYING_ADDRESS) throw new Error('LAVA_UNDERLYING not set in .env');

const MINE_DECIMALS = 18;
const MINE_NAME     = 'xLava';
const MINE_SYMBOL   = 'xLAVA';
...
console.log('=== xLava Mine Deployment ===');
...
console.log('\n=== Done ===');
console.log('xLava Mine address:', result.contractAddress);
console.log('xLava Mine pubkey :', result.contractPubKey);
