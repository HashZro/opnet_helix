...
const MINE_NAME     = 'xMoto';
const MINE_SYMBOL   = 'xMOTO';
...
console.log('=== xMoto Mine Deployment ===');
...
console.log('\n=== Done ===');
console.log('xMoto Mine address:', result.contractAddress);
console.log('xMoto Mine pubkey :', result.contractPubKey);
