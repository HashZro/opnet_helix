...
const MINE_ADDRESS       = process.env.CRYSTAL_MINE_ADDRESS;

if (!FACTORY_ADDRESS)    throw new Error('FACTORY_ADDRESS not set');
if (!UNDERLYING_ADDRESS) throw new Error('CRYSTAL_UNDERLYING not set');
if (!MINE_ADDRESS)       throw new Error('CRYSTAL_MINE_ADDRESS not set');
...
console.log('=== Register xCrystal Mine in Factory ===');
...
console.log('\n=== xCrystal Mine registered in Factory ===');
