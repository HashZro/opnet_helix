...
const MINE_ADDRESS       = process.env.STORM_MINE_ADDRESS;

if (!FACTORY_ADDRESS)    throw new Error('FACTORY_ADDRESS not set');
if (!UNDERLYING_ADDRESS) throw new Error('STORM_UNDERLYING not set');
if (!MINE_ADDRESS)       throw new Error('STORM_MINE_ADDRESS not set');
...
console.log('=== Register xStorm Mine in Factory ===');
...
console.log('\n=== xStorm Mine registered in Factory ===');
